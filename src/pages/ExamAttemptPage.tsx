...
export default function ExamAttemptPage() {
  ...
  try {
    ...
    const attemptCheck =
      await axios.get(
        `https://online-exam-backend-production-6419.up.railway.app/api/results/attempted/${email}/${id}`
      );
    ...
    const res = await axios.get(
      `https://online-exam-backend-production-6419.up.railway.app/api/questions/exam/${id}`
    );
  ...
  if (answers[q.id] === correctOption) {
    ...
    const status =
     ...
     await axios.post("https://online-exam-backend-production-6419.up.railway.app/api/results/submit", {
      studentEmail:
        localStorage.getItem("email") ||
        "student@gmail.com",
