...
function StudentPage() {
 ...
 const fetchExams = async () => {
  ...
  try {
    ...
    const response =
      await axios.get(
        "https://online-exam-backend-production-89c9.up.railway.app/api/exams"
      );
      ...
      await Promise.all(
        ...
        response.data.map(
          async (exam: Exam) => {
            ...
            const attempted =
              await axios.get(
                `https://online-exam-backend-production-89c9.up.railway.app/api/results/attempted/${email}/${exam.id}`
              );
